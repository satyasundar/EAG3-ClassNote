...
from prefab_ui.components import Button, Card, CardContent, CardHeader, CardTitle, Column, H1, Row
...
with PrefabApp(state={"count": 50}, css_class="max-w-md mx-auto") as app:
    with Card():
        with CardHeader():
            CardTitle("Counter")
        with CardContent():
